# Spec: gestionar-conectores-automatizacion-navegador

## Purpose

Cumplir el requisito de autorización explícita de conectores Playwright ya documentado en `integraciones-api-browser-automation` (tarea 09): registrar un conector asociado a un sistema externo, autorizarlo explícitamente y registrar sus perfiles de autenticación sin guardar credenciales reales.
