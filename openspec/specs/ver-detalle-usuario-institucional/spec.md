# ver-detalle-usuario-institucional Specification

## Purpose
Página de detalle de un usuario institucional en modo consulta: identidad y estado de cuenta, ámbito institucional (jurisdicción → centro financiero → centro de costo), roles y permisos efectivos, actividad reciente de negocio y de seguridad, y acceso a las acciones de cuenta ya implementadas según permiso. Es de solo lectura respecto de los datos que presenta.
## Requirements
