# Spec: consulta-definiciones-workflow

## Purpose

Exponer, de solo lectura, las definiciones de workflow ya sembradas por cada módulo (estados, transiciones, permisos requeridos, documentos requeridos), para que sean consultables en vez de solo legibles desde el código de los seeders.
