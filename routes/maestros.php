...
use App\Http\Controllers\Maestros\TipoCompraController;
...
Route::middleware(['auth'])->prefix('maestros')->name('maestros.')->group(function () {
    ...
    Route::get('tipos-compra', [TipoCompraController::class, 'index'])->name('tipos-compra.index');
    Route::get('tipos-compra/crear', [TipoCompraController::class, 'create'])->name('tipos-compra.create');
    Route::post('tipos-compra', [TipoCompraController::class, 'store'])->name('tipos-compra.store');
    Route::get('tipos-compra/{tipoCompra}', [TipoCompraController::class, 'show'])->name('tipos-compra.show');
    Route::get('tipos-compra/{tipoCompra}/editar', [TipoCompraController::class, 'edit'])->name('tipos-compra.edit');
    Route::patch('tipos-compra/{tipoCompra}', [TipoCompraController::class, 'update'])->name('tipos-compra.update');
    Route::delete('tipos-compra/{tipoCompra}', [TipoCompraController::class, 'destroy'])->name('tipos-compra.destroy');
