...
use App\Policies\ConsumoBasicoPolicy;
...
use App\Policies\ExcepcionInformeRazonadoPolicy;
use App\Policies\GraficoInformeRazonadoPolicy;
use App\Policies\IndicadorEconomicoImportacionPolicy;
use App\Policies\ItemPolicy;
use App\Policies\LicitacionMercadoPublicoPolicy;
use App\Policies\MetricaInformeRazonadoPolicy;
...
use App\Policies\SeccionInformeRazonadoPolicy;
use App\Policies\TipoCompraPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    protected function configureAuthorization(): void
    {
        ...
        Gate::policy(CorteReportabilidad::class, CorteReportabilidadPolicy::class);
        ...
        Gate::policy(ExcepcionInformeRazonado::class, ExcepcionInformeRazonadoPolicy::class);
        Gate::policy(NarrativaInformeRazonado::class, NarrativaInformeRazonadoPolicy::class);
        Gate::policy(SeccionInformeRazonado::class, SeccionInformeRazonadoPolicy::class);
        Gate::policy(MetricaInformeRazonado::class, MetricaInformeRazonadoPolicy::class);
        Gate::policy(GraficoInformeRazonado::class, GraficoInformeRazonadoPolicy::class);
        ...
        Gate::policy(TipoCompra::class, TipoCompraPolicy::class);
        ...
        Gate::policy(ConsumoBasico::class, ConsumoBasicoPolicy::class);
