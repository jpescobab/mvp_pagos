...
import { InstitucionActionsMenu } from '@/components/maestros/institucion-actions-menu';
...
type PageProps = {
    instituciones: Paginated<Institucion>;
    q: string | null;
};

export default function InstitucionesIndex() {
    const { instituciones: pagina, q } = usePage<PageProps>().props;
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <Button asChild>
                            <Link href={instituciones.create().url}>
                                Nueva institución
                            </Link>
                        </Button>
                    </div>
                ...
                <div className="overflow-x-auto rounded-xl border">
                    <table className="w-full table-fixed text-xs">
                        <thead className="bg-muted/50 text-left text-[10px] tracking-wide text-muted-foreground uppercase">
                            <tr>
                                <th className="w-[50%] px-2.5 py-1 font-medium">
                                    Institución
                                </th>
                            ...
                            {pagina.data.map((institucion) => (
                                ...
                                >
                                    ...
                                    <td className="px-2.5 py-1 text-muted-foreground">
                                        {formatNumero(
                                            institucion.jurisdicciones_count ??
                                                0,
                                        )}
                                    </td>
                                    <td className="px-2.5 py-1">
