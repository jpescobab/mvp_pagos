...
export default function InstitucionesCrear() {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                ...
                <div className="flex gap-2">
                    ...
                    <Button
                        variant="outline"
                        disabled={procesando}
                        onClick={() => router.get(instituciones.index().url)}
                    >
                        Cancelar
                    </Button>
                </div>
...
InstitucionesCrear.layout = {
    breadcrumbs: [
        { title: 'Instituciones', href: instituciones.index() },
        { title: 'Nueva', href: instituciones.create() },
    ],
};
