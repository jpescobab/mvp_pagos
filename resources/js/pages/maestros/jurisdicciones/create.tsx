...
import type { InstitucionSeleccionable } from '@/types/maestros';

type PageProps = {
    instituciones: InstitucionSeleccionable[];
};

export default function JurisdiccionesCrear() {
    const { instituciones } = usePage<PageProps>().props;
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                ...
                <div className="flex gap-2">
                    ...
                    <Button
                        variant="outline"
                        disabled={procesando}
                        onClick={() => router.get(jurisdicciones.index().url)}
                    >
                        Cancelar
                    </Button>
                </div>
...
JurisdiccionesCrear.layout = {
    breadcrumbs: [
        { title: 'Jurisdicciones', href: jurisdicciones.index() },
        { title: 'Nueva', href: jurisdicciones.create() },
    ],
};
