...
export default function ProveedoresCrear({ catalogos }: PageProps) {
    ...
    const [tipoContribuyente, setTipoContribuyente] = useState(SIN_SELECCION);
    ...
    const [banco, setBanco] = useState(SIN_SELECCION);
    const [bancoLibre, setBancoLibre] = useState('');
    const [tipoCuenta, setTipoCuenta] = useState(SIN_SELECCION);
    const [numeroCuenta, setNumeroCuenta] = useState('');
    const [condicionPago, setCondicionPago] = useState(
        catalogos.condicionesPago.find((o) => o.value === 'dias_30')?.value ??
    ...
    const bancoFinal = banco === OTRO_BANCO ? bancoLibre : banco;
                        ...
                        <div className="mt-6 flex items-center justify-between border-t pt-4">
                            <div className="flex gap-2">
                                <Button
                                    ...
                                    disabled={procesando}
                                    onClick={() =>
                                        router.get(proveedores.index().url)
                                    }
                                >
                                    Cancelar
                                </Button>
