...
type PageProps = {
    tiposCompra: Paginated<TipoCompraMaestro>;
    q: string | null;
};

export default function TiposCompraIndex() {
    const { tiposCompra: pagina, q } = usePage<PageProps>().props;
                ...
                <div className="overflow-x-auto rounded-xl border">
                    <table className="w-full table-fixed text-xs">
                        <thead className="bg-muted/50 text-left text-[10px] tracking-wide text-muted-foreground uppercase">
                            <tr>
                                <th className="w-[45%] px-2.5 py-1 font-medium">
                                    Nombre
                                </th>
                        ...
                        <tbody className="divide-y">
                            {pagina.data.length === 0 && (
                                <tr>
                                    ...
                                    >
                                        Sin tipos de compra que coincidan.
                                    </td>
                                </tr>
                            )}
                            {pagina.data.map((tipo) => (
