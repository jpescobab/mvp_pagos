...
Dominios ad-hoc adicionales (módulos y consultas agregados fuera de `tasks/01..10`): `adquisiciones`, `api-adquisiciones`, `api-pago-proveedores`, `paginas-adquisiciones`, `paginas-pago-proveedores`, `tema-visual-layout`, `consulta-catalogo-proveedores`, `consulta-definiciones-workflow`, `consulta-importaciones-sgf`, `consulta-indicadores-economicos`.
